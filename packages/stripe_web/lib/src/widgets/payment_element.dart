  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (el != null) {
        ...
        final createdElement = elements!.createPayment(elementOptions())
          ..mount('#payment-element'.toJS)
          ..onChange(onCardChanged)
          ..onFocus(requestFocus)
          ..onBlur(requestBlur);

        WebStripe.element = createdElement;

        final stripeIframe = web.document
            .getElementsByClassName('__PrivateStripeElement')
            .item(0);
        if (stripeIframe != null) {
          resizeObserver.observe(stripeIframe as web.HTMLElement);
        }
      }
    });
  }
