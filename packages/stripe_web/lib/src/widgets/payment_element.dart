...
class PaymentElementState extends State<PaymentElement> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final js.StripeElements createdElements =
          WebStripe.js.elements(createOptions());
      WebStripe.elements = createdElements;
      WebStripe.element = createdElements.createPayment(elementOptions())
        ..mount('#payment-element'.toJS)
        ..onBlur(requestBlur)
        ..onFocus(requestFocus)
        ..onChange(onCardChanged);
